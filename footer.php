	...
	<footer id="footer">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-3">
	                <a href="homepage.php"><img src="image/TDicon.png" alt="" class="img-fluid logo-footer"></a>
	            ...
	            <div class="col-md-3">
	                <div class="useful-link">
	                    ...
	                    <form action="send_message.php" method="post">
	                        <div class="mb-3" style="max-width: 300px; margin: auto; padding: auto; border-radius: 5px;">
