...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($producer_name)) {
        ...
        $stmt = $conn->prepare("INSERT INTO producer (producer_name) VALUES (?)");
        if ($stmt) {
...
<head>
    <meta charset="UTF-8">
    <title>Add Producer - TD Motor</title>
    ...
    <div class="container-fluid">
        <div class="row" style="height: calc(100vh - 56px);">
            ...
            <main class="col-md-9 col-lg-10 p-4">
                <h3 class="mb-4">Add New Producer</h3>
                <p>Use this form to add a new producer to your system.</p>
