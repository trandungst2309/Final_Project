...
.logo-img {
    ...
    /* Căn giữa logo */
    display: block;
    /* Đảm bảo hình ảnh là block để margin: auto hoạt động */
}
</style>
                ...
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                        ...
                        <div class="pcoded-inner-content">
                            <img src="image/TDlogo.png" alt="Logo" class="logo-img"
                                style="border-radius: 50px 50px; width: 30%; height: auto; padding:10px; margin: 20px auto; display: block;">
