...
?>
            <div class='col-md-4 mb-4'>
                <div class='card'>
                    <img src='./uploads/<?= htmlspecialchars($r["product_img"]) ?>' alt='<?= htmlspecialchars($r["product_name"]) ?>' class='card-img-top' />
                    <div class="card-body">
                        <a href="product_detail.php?product_id=<?= htmlspecialchars($r['product_id']) ?>" class="text-decoration-none">
                        ...
                        <a href='product_detail.php?product_id=<?= htmlspecialchars($r['product_id']) ?>' class='btn btn-view-details'>View Detail</a>
                    </div>
                </div>
            </div>
<?php
        ...
        echo "<div class='alert alert-warning' role='alert'>No results found for '$nameP'. Please try again with different keywords.</div>";
    }
    echo "</div>";
}
?>
